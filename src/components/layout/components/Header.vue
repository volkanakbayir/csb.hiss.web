<template>
    <header id="header">
        <div id="logo-group">
            ...
            <span id="logo">
                <img src="../../../assets/logo.png" alt="SmartAdmin">
            </span>
        ...
        <div class="pull-right">
                    ...
                    <div class="popover bottom">
                        ...
                        <div class="popover-content">
                            ...
                            <h4 class="vc-title-error text-center">
                                ...
                                <br>
                                <small class="txt-color-red">Must
                                    <strong>"Allow"</strong> Microphone</small>
                                <br>
                                <small class="txt-color-red">Must have
            ...
            <ul class="header-dropdown-list hidden-xs">
                <li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="img/blank.gif" class="flag flag-us" alt="United States">
